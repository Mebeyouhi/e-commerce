...
<body>
 ...
 <section id= "header">
    <a href="#"><img src="imag%20logo.png.png"  
      ...
      <li><a class="active" href="cart.aspx"><i class="fa-solid fa-bag-shopping"></i></a></li>
    </ul>
    </div>
      </section>
      <section id="page-header" class="about-header">
       <h2 class="style1" style="color: #FFFFFF">#let's_talk</h2>      
 <p style="color: #FFFFFF">LEAVE A MESSAGE.We Love to hear from you!</p>
  ...
  <table width="100%">
    ...
    <tr>
        ...
        <td><img src="order/bro%201.jpg" /></td>
     ...
     <tr>
        <td><a href="#"><i class="far fa-times-circle"></i></a></td>
        <td><img src="order/Vishali.jpg" /></td>
        <td>Cartoon Astronaut Shirt</td>
        <td>$90.00</td>
        <td><input type="number" value="1"></td>
        <td>$90.00</td>
